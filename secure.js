...
snapshot.services = {
service_mood: document.querySelector('[name="mood_service"]')?.value || "",
special_requests: document.querySelector('[name="special_requests_service"]')?.value || "",

viewing: {
location_place: document.querySelector('[name="viewing_location_place"]')?.value || "",
location_call: document.querySelector('[name="viewing_location_call"]')?.value || "",
location_other: document.querySelector('[name="viewing_location_other"]')?.value || "",
spiritual_traditions_notes: document.querySelector('[name="viewing_spiritual_traditions_notes"]')?.value || "",
jewelry_notes: document.querySelector('[name="viewing_jewelry_notes"]')?.value || "",
clothing_notes: document.querySelector('[name="viewing_clothing_notes"]')?.value || ""
},

memorial: {
location_place: document.querySelector('[name="memorial_location_place"]')?.value || "",
location_call: document.querySelector('[name="memorial_location_call"]')?.value || "",
location_other: document.querySelector('[name="memorial_location_other"]')?.value || "",
spiritual_traditions_notes: document.querySelector('[name="memorial_spiritual_traditions_notes"]')?.value || ""
},

celebration: {
location_place: document.querySelector('[name="celebration_location_place"]')?.value || "",
location_call: document.querySelector('[name="celebration_location_call"]')?.value || "",
location_other: document.querySelector('[name="celebration_location_other"]')?.value || "",
spiritual_traditions_notes: document.querySelector('[name="celebration_spiritual_traditions_notes"]')?.value || ""
}
};
}
...
social_security_number: document.querySelector('[name="social_security_number"]')?.value || "",
dob: document.querySelector('[name="dob"]')?.value || "",
place_of_birth: document.querySelector('[name="place_of_birth"]')?.value || "",
county: document.querySelector('[name="county"]')?.value || "",
veteran_status: document.querySelector('[name="veteran_status"]')?.value || "",
veteran_notes: document.querySelector('[name="veteran_notes"]')?.value || "",
flag_presented_to: document.querySelector('[name="flag_presented_to"]')?.value || "",
dd214_location: document.querySelector('[name="dd214_location"]')?.value || ""
};
}
function buildCemeteryFromForm(snapshot) {
snapshot.cemetery = {
cemetery_name: document.querySelector('[name="cemetery_name"]')?.value || "",
cemetery_location: document.querySelector('[name="cemetery_location"]')?.value || "",
cemetery_section: document.querySelector('[name="cemetery_section"]')?.value || "",
cemetery_lot: document.querySelector('[name="cemetery_lot"]')?.value || "",
cemetery_grave_number: document.querySelector('[name="cemetery_grave_number"]')?.value || "",
interment_type: document.querySelector('[name="interment_type"]')?.value || "",
timing_of_services_and_disposition: document.querySelector('[name="timing_of_services_and_disposition"]')?.value || "",
remains_container: document.querySelector('[name="remains_container"]')?.value || "",
remains_out_of_state: document.querySelector('[name="remains_out_of_state"]')?.value || "",
remains_notes: document.querySelector('[name="remains_notes"]')?.value || ""
};
}
...
const snapshot = Array.isArray(raw) && raw[0]?.body ? JSON.parse(raw[0].body) : raw;
